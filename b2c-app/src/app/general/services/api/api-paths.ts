...
//export const AUTOCOMPLETE_PATH = '/servlet/ac.json';
...
export const API_SERVER_PREPROD_PATH = 'https://preprod-wapi.travelstart.com';
export const API_SERVER_BETA_PATH = 'https://beta-wapi.travelstart.com';
export const API_SERVER_ALPHA_PATH = 'https://alpha-wapi.travelstart.com';

/**
 * B2B api server paths
 */
export const B2B_API_SERVER_BETA_PATH = 'https://beta-b2b-api.travelstart.com';
export const B2B_API_SERVER_PREPROD_PATH = 'https://preprod-b2b-api.travelstart.com';
export const B2B_API_SERVER_LIVE_PATH = 'https://b2b-api.travelstart.com';
export const B2B_WEBAPI_PATH = '/b2b-stage/webapi';
export const B2B_STAGE_PATH = '/b2b-stage';
export const FLIGHT_EDIT_PRICE = '/editprice';
export const PAYMENT_PATH = '/payment';
export const FLIGHT_BOOK = '/book';
...
export const B2B_USER_DATA = '/accounts/me/';
export const B2B_AGENCY_INFO = '/core/agency-info';
export const WALLET_VOUCHER_BALANCE = 'api/v1/wallet/balance';
/**
 * Airports path
 */
...
export const AIRPORTS_ALPHA_PATH = 'https://alpha-lapi.travelstart.com';
...
export const S3_BUCKET_PATH = 'https://s3.eu-west-2.amazonaws.com/fastpix.travelstart.com/';
export const S3_ERROR_MAPPING_PATH = 'assets/json/error-mapping.json';
export const ASSET_TRANSLATION_PATH = 'assets/translations/';
export const COUNTRIES_LIST_PATH = 'assets/json/countries.json';
...
export const ACCOUNT_USER_RESEND_ACTIVATION_EMAIL_PATH = 'v1/user/resend-activation-email';
export const ACCOUNT_USER_OTP_LOGIN = 'v1/user/login-otp-gen';
export const ACCOUNT_USER_OTP_VERIFICATION = 'v1/user/login-otp-ver';
export const ACCOUNT_USER_MULTIPLY_FAMILY = 'v1/user/multiply/family';
export const ABSA_USER_PATH = 'v1/user/absa';
export const ABSA_AUTH0_PATH = '/absa/auth0';
export const ABSA_AUTH_PATH = '/absa/auth';
...
export const VERTEIL_SEAT_LAYOUT_SEARCH = '/seat-layout-search';
...
export const TS_ANALYTICS_API_ALPHA_PATH = 'https://alpha-anna.travelstart.com';
...
/**API for price with calender */

export const PRICE_WITH_CALENDAR =
  'https://europe-west2-ts-dev-dataops-prod.cloudfunctions.net/cms_calendar?api_key=tXr0HiFpxT2vWBT';
/**
 * API's for twak chat
 */
export const TAWK_NG_API = 'https://embed.tawk.to/5e737a30eec7650c332124a6/1gjr0cnvp';
export const TAWK_ZA_API = 'https://embed.tawk.to/590b02ae4ac4446b24a6d2d2/1eq7s6k31';


/**TS-Plus API's */
export const TS_PLUS_PAYMENT_LIVE_PATH = 'https://peachpayment.travelstart.com/'; 
export const TS_PLUS_SUBSCRIPTIONSTATUS = 'api/v1/subscriptions/tsplus';

/**Strapi contact-us form Categories keys APIs */
export const CONTACT_US_FORM_FIELDS = 'contact-us-form-fields?populate=contact_reason.subCategories'
export const CONATCT_US_CATEGORIES_BETA_PATH = 'https://beta-strapi.travelstart.com/api/';
export const CONATCT_US_CATEGORIES_PREPROD_PATH = 'https://beta-strapi.travelstart.com/api/';
export const CONATCT_US_CATEGORIES_ALPHA_PATH = 'https://beta-strapi.travelstart.com/api/';
export const CONATCT_US_CATEGORIES_LIVE_PATH = 'https://strapi.travelstart.com/api/';

/**get peach CheckoutId Url for BNPL(buy now pay later) */
export const GET_PEACH_CHECKOUT_ID_TEST = 'https://peach-checkout-staging.travelstart.com/checkout';
export const GET_PEACH_CHECKOUT_ID_LIVE = 'https://peach-checkout.travelstart.com/checkout';

/** Meili embed integration Urls */
export const MEILI_DIRECT_ALPHA = 'https://uat-direct-ux.meili.travel/index.js';
export const MEILI_DIRECT_PREPROD = 'https://preprod-direct-ux.meili.travel/index.js';
export const MEILI_DIRECT_LIVE = 'https://direct-ux.meili.travel/index.js';
export const MEILI_CONNECT_TEST = 'https://preprod-connect-ux.meili.travel/index.js';
export const MEILI_CONNECT_LIVE = 'https://connect-ux.meili.travel/index.js';
export const MEILI_BOOKING_MANAGER_TEST = 'https://preprod-booking-ux.meili.travel/index.js';
export const MEILI_BOOKING_MANAGER_LIVE = 'https://booking-ux.meili.travel/index.js';

/**Hotel Hapi Apis */
export const HAPI_BASE_URL_TEST = 'https://hapi-service-staging.hotelsapi.net/';
export const HAPI_BASE_URL_LIVE = 'https://hapi-service-prod-v2.hotelsapi.net/';
export const HAPI_AUTHENTICATE = 'user/authenticate';
export const HOTEL_BOOKING_LIST = 'userAccountHistory';
export const HOTEL_BOOKING_CANCEL = 'api/v2/cancelbooking';
/**momentum redumptiom API */
export const MOMENTUM_PROXY_API_TEST = 'https://partner-proxy-test-80142608037.europe-west2.run.app/';
...
export const ITERABLE_API_TEST = 'https://bff-apigw-test.travelstart.com/iterable/generate-jwt';
export const ITERABLE_API_LIVE = 'https://bff-apigw.travelstart.com/iterable/generate-jwt';


/** proxy server routes */
export const PROXY_SERVER_PATH = '/server';
export const PROXY_AUTHENTICATION = '/authentication';
export const PROXY_LOGIN = '/login';
export const PROXY_USER_DATA = '/userData';
export const PROXY_USER_OTP_DATA = '/userOTPData';
export const PROXY_MY_BOOKINGS = '/myBookings';
export const PROXY_BOOKFLIGHT = '/bookFlight';
export const PROXY_My_ACCOUNT_TRAVELLERS = '/traveller';
export const PROXY_My_ACCOUNT_PAYMENT_CARD = '/payment/card';
...
export const PROXY_FRESHDESK_TICKETS_BY_EMAIL = '/freshdesk/tickets';
export const PROXY_FRESHDESK_TICKET_DETAILS = '/freshdesk/ticket-details';
export const PROXY_FRESHDESK_CHAT_ON_TICKET = '/freshdesk/chat';
export const PROXY_BIN_LOOKUP = '/binValidation';
export const PROXY_NGOFFLINE_BOOKING = '/ngOfflineBooking';
export const PROXY_BUTTERCMS = '/buttercms-carousel';
export const PROXY_BUTTERCMS_FAQ = '/buttercms-faq-page';
export const PROXY_BUTTERCMS_MEMBER_DEALS = '/buttercms-member-deals';
export const PROXY_RESEND_ETICKET = '/resend-ticket';
export const PROXY_ACCOUNT_DELETE = '/account/delete';
export const PROXY_CANCEL_HOTEL_BOOKING = '/hotel/cancel-booking';
export const PROXY_PEACHPAYMENT_STATUS = '/getPaymentStatus';
export const PROXY_PEACH_REVERSE_PAYMENT = '/reversePayment';
export const PROXY_PEACH_CHECKOUTID = '/peachCreateCheckoutID';
export const PROXY_PEACH_TOKENLOGS = '/tokenLogs';
export const PROXY_PEACH_PAYMENTLOGS = '/paymentStatusLogs';
export const PROXY_MM_FAMILYCOMPOSITION = '/family-composition';
export const PROXY_ABSA_USER = '/absa-user';
export const PROXY_WALLET_VOUCHERS = '/wallet-vouchers';
export const PROXY_VALIDATE_WALLET_VOUCHERS = '/validate-wallet-voucher';
export const PROXY_WALLET_BALANCE_UPDATE = '/wallet-balance-update';
export const PROXY_REDEEM_PARTNER_REWARDS = '/redeemPartnerRewards';
export const PROXY_ITERABLE_JWT_TOKEN = '/iterableJWTToken';
